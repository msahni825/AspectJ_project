...
////			}
////		
////	// Continuous roll backs not allowed
////		before(Transaction i) throws RollbackException:
////			call(* Transaction.rollback()) && target(i)
////			{
////			// && transProp.contains("Transaction.rollback()")
...
////	
////	
////	//modify between start and commit
...
////		}
////	
////	//modify occurs between start and commit
...
//	}
//
//	public final void event_rollback_3(Transaction i) {
//		int numAlive = 0 ;
//		for(int i_1 = 0; i_1 < this.size; i_1++){
//			TransactionMonitor monitor = (TransactionMonitor)this.elementData[i_1];
//			if(!monitor.MOP_terminated){
...
//				numAlive++;
//
//				monitor.Prop_1_event_rollback_3(i);
//				if(monitor.Prop_1_Category_fail) {
//					monitor.Prop_1_handler_fail(i);
//				}
//			}
...
//	}
//
//	public final void event_rollback_4(Transaction i) {
//		int numAlive = 0 ;
//		for(int i_1 = 0; i_1 < this.size; i_1++){
//			TransactionMonitor monitor = (TransactionMonitor)this.elementData[i_1];
//			if(!monitor.MOP_terminated){
...
//				numAlive++;
//
//				monitor.Prop_1_event_rollback_4(i);
//				if(monitor.Prop_1_Category_fail) {
//					monitor.Prop_1_handler_fail(i);
//				}
//			}
...
//
//	int Prop_1_state;
//	static final int Prop_1_transition_commit[] = {4, 4, 4, 1, 4};;
//	static final int Prop_1_transition_start[] = {2, 3, 4, 4, 4};;
//	static final int Prop_1_transition_modify[] = {4, 4, 2, 3, 4};;
//	static final int Prop_1_transition_rollback[] = {4, 4, 1, 4, 4};;
//
...
//	}
//
//	public final void Prop_1_event_rollback_3(Transaction i) {
//		MOP_lastevent = 4;
//
...
//	}
//
//	public final void Prop_1_event_rollback_4(Transaction i) {
//		MOP_lastevent = 5;
//
//		Prop_1_state = Prop_1_transition_rollback[Prop_1_state];
//		Prop_1_Category_fail = Prop_1_state == 4;
...
//	static javamoprt.map.MOPRefMap WebTest_Transaction_RefMap = Transaction_i_Map;
//
...
//	}
//
//	pointcut Transaction_rollback_3(Transaction i) : (call(* Transaction.rollback()) && target(i)) && MOP_CommonPointCut();
//	before (Transaction i) : Transaction_rollback_3(i) {
//		Transaction_activated = true;
//		synchronized(WebTest_MOPLock) {
//			//Transaction_rollback_4
//			{
//				TransactionMonitor mainMonitor = null;
//				javamoprt.map.MOPMap mainMap = null;
//				javamoprt.ref.MOPWeakReference TempRef_i;
...
//				}
//
//				mainMonitor.Prop_1_event_rollback_4(i);
//				if(mainMonitor.Prop_1_Category_fail) {
//					mainMonitor.Prop_1_handler_fail(i);
//				}
//			}
//			//Transaction_rollback_3
//			{
//				TransactionMonitor mainMonitor = null;
//				javamoprt.map.MOPMap mainMap = null;
//				javamoprt.ref.MOPWeakReference TempRef_i;
...
//				}
//
//				mainMonitor.Prop_1_event_rollback_3(i);
//				if(mainMonitor.Prop_1_Category_fail) {
//					mainMonitor.Prop_1_handler_fail(i);
//				}
//			}
